...
import { tariffPrices, getVsbPrices, getWhisperPrices, getPartialNumbers, listVoicemails, createVoicemail, getHuntGroup, createHuntGroup, listGreetings, createGreeting, listBlacklist, addToBlacklist, getHolidaySettings, createHolidaySetting } from '../services/tamarApi.js';
...
router.get('/holiday-settings', getHolidaySettings);
router.post('/holiday-settings/new', createHolidaySetting);
